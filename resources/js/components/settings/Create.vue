  ...
  <div>
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Add Store Info</li>
            </ol>
          </div>
      <div class="col-xl-12 col-lg-12 col-md-12">
        <div class="card shadow-sm">
          <div class="card-header text-center h4 text-gray-900">
            <i class="fas fa-user-plus"></i>  Add Store Info
            <router-link to="/setting" class="btn btn-info" style="float:right"><i class="far fa-eye"></i></router-link>
          </div>
          <div class="card-body p-0">
            <div class="row">
              <div class="col-lg-12">
                <div class="login-form">
                    <form class="store" @submit.prevent="addStoreInfo" enctype="multipart/form-data">
                              <div class="form-row">
  ...
  export default {
    ...
    methods:{
        ...
        addStoreInfo(){
          ...
          .then(res => {
            Notification.success("Store Info added successfully!")
