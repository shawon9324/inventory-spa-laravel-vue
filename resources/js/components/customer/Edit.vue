  ...
  <div>
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Edit Customer Info</li>
            </ol>
          </div>
      <div class="col-xl-12 col-lg-12 col-md-12">
        <div class="card shadow-sm">
          <div class="card-header text-center h4 text-gray-900">
            <i class="fas fa-user-edit"></i>  Edit Customer Info &nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="login-form">
                    <form id="edit-customer" class="customer" @submit.prevent="updateCustomer" enctype="multipart/form-data">
                              <div class="form-row">
                                <div class="form-group col-md-6">
                                  <input type="text" class="form-control" id="name"  placeholder="Customer Name" v-model="form.name">
